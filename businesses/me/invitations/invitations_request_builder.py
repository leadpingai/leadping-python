...
if TYPE_CHECKING:
    from ....models.business_invitation_request import BusinessInvitationRequest
    from ....models.business_invitation_response import BusinessInvitationResponse
...
class InvitationsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/businesses/me/invitations", path_parameters)
    ...
    def by_invitation_id(self,invitation_id: str) -> WithInvitationItemRequestBuilder:
        ...
        param invitation_id: The ID of the current-business invitation to revoke.
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[list[BusinessInvitationTableRow]]:
        """
        ...
        Returns: Optional[list[BusinessInvitationTableRow]]
        """
    ...
    async def post(self,body: BusinessInvitationRequest, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[BusinessInvitationResponse]:
        ...
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[BusinessInvitationResponse]
        """
        if body is None:
        ...
        return await self.request_adapter.send_async(request_info, BusinessInvitationResponse, error_mapping)
    ...
    def to_post_request_information(self,body: BusinessInvitationRequest, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Creates an invitation for the current business so another user can join with the requested role and account access.
        param body: Request payload for business invitation.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
