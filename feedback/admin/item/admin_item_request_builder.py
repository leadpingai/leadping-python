...
if TYPE_CHECKING:
    from ....models.feedback_admin_update_request import FeedbackAdminUpdateRequest
    from ....models.feedback_response import FeedbackResponse
    from ....models.problem_details import ProblemDetails

class AdminItemRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/feedback/admin/{id}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[FeedbackResponse]:
        """
        ...
        return await self.request_adapter.send_async(request_info, FeedbackResponse, error_mapping)
    ...
    def with_url(self,raw_url: str) -> AdminItemRequestBuilder:
        """
        ...
        return AdminItemRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class AdminItemRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
    ...
    @dataclass
    class AdminItemRequestBuilderPutRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
