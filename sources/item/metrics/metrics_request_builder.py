...
if TYPE_CHECKING:
    ...
    from ....models.source_metrics_response import SourceMetricsResponse
...
class MetricsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/sources/{id}/metrics{?days*,endAt*,startAt*}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[MetricsRequestBuilderGetQueryParameters]] = None) -> Optional[SourceMetricsResponse]:
        ...
        return await self.request_adapter.send_async(request_info, SourceMetricsResponse, error_mapping)
