...
@dataclass
class AutomationActionRunRecord_smsDelivery(AutomationSmsDeliveryRecord, Parsable):
    """
    Delivery outcome of the persisted SMS. Workflow steps advance on command acceptance, without waiting for delivery.
    """
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> AutomationActionRunRecord_smsDelivery:
        """
