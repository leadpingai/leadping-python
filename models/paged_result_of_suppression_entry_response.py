...
if TYPE_CHECKING:
    from .suppression_entry_response import SuppressionEntryResponse

@dataclass
class PagedResultOfSuppressionEntryResponse(AdditionalDataHolder, Parsable):
    """
    ...
    items: Optional[list[SuppressionEntryResponse]] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> PagedResultOfSuppressionEntryResponse:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: PagedResultOfSuppressionEntryResponse
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return PagedResultOfSuppressionEntryResponse()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "items": lambda n : setattr(self, 'items', n.get_collection_of_object_values(SuppressionEntryResponse)),
