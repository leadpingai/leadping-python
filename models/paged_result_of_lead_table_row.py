...
if TYPE_CHECKING:
    from .lead_table_row import LeadTableRow

@dataclass
class PagedResultOfLeadTableRow(AdditionalDataHolder, Parsable):
    """
    ...
    def create_from_discriminator_value(parse_node: ParseNode) -> PagedResultOfLeadTableRow:
        ...
        Returns: PagedResultOfLeadTableRow
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return PagedResultOfLeadTableRow()
