...
if TYPE_CHECKING:
    from .business_table_row import BusinessTableRow

@dataclass
class PagedResultOfBusinessTableRow(AdditionalDataHolder, Parsable):
    """
    ...
    items: Optional[list[BusinessTableRow]] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> PagedResultOfBusinessTableRow:
        """
        ...
        return PagedResultOfBusinessTableRow()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "items": lambda n : setattr(self, 'items', n.get_collection_of_object_values(BusinessTableRow)),
