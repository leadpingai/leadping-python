...
if TYPE_CHECKING:
    from .lead_status_change_response import LeadStatusChangeResponse

@dataclass
class PagedResultOfLeadStatusChangeResponse(AdditionalDataHolder, Parsable):
    """
    ...
    items: Optional[list[LeadStatusChangeResponse]] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> PagedResultOfLeadStatusChangeResponse:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: PagedResultOfLeadStatusChangeResponse
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "items": lambda n : setattr(self, 'items', n.get_collection_of_object_values(LeadStatusChangeResponse)),
