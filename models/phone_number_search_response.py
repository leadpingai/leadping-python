...
if TYPE_CHECKING:
    from .phone_number_search_result import PhoneNumberSearchResult
...
class PhoneNumberSearchResponse(AdditionalDataHolder, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> PhoneNumberSearchResponse:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: PhoneNumberSearchResponse
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "numbers": lambda n : setattr(self, 'numbers', n.get_collection_of_object_values(PhoneNumberSearchResult)),
        }
        return fields
