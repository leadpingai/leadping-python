...
@dataclass
class PagedResultOfFeedbackResponse(AdditionalDataHolder, Parsable):
    """
    ...
    items: Optional[list[FeedbackResponse]] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> PagedResultOfFeedbackResponse:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: PagedResultOfFeedbackResponse
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return PagedResultOfFeedbackResponse()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "items": lambda n : setattr(self, 'items', n.get_collection_of_object_values(FeedbackResponse)),
