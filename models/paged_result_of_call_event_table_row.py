...
if TYPE_CHECKING:
    from .call_event_table_row import CallEventTableRow

@dataclass
class PagedResultOfCallEventTableRow(AdditionalDataHolder, Parsable):
    """
    ...
    items: Optional[list[CallEventTableRow]] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> PagedResultOfCallEventTableRow:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: PagedResultOfCallEventTableRow
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "items": lambda n : setattr(self, 'items', n.get_collection_of_object_values(CallEventTableRow)),
