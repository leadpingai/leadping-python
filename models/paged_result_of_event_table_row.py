...
if TYPE_CHECKING:
    from .event_table_row import EventTableRow
...
class PagedResultOfEventTableRow(AdditionalDataHolder, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> PagedResultOfEventTableRow:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: PagedResultOfEventTableRow
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return PagedResultOfEventTableRow()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "items": lambda n : setattr(self, 'items', n.get_collection_of_object_values(EventTableRow)),
