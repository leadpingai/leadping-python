...
if TYPE_CHECKING:
    from ...models.change_billing_plan_request import ChangeBillingPlanRequest
    from ...models.problem_details import ProblemDetails
    from ...models.user_response import UserResponse

class ChangeBillingPlanRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/users/change-billing-plan", path_parameters)
    ...
    def with_url(self,raw_url: str) -> ChangeBillingPlanRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: ChangeBillingPlanRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return ChangeBillingPlanRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class ChangeBillingPlanRequestBuilderPutRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
