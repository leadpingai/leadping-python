...
if TYPE_CHECKING:
    from ...models.compliance_update_request import ComplianceUpdateRequest
...
class ComplianceRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/users/compliance", path_parameters)
    ...
    @dataclass
    class ComplianceRequestBuilderPutRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
