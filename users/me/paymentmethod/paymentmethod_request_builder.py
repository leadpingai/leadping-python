...
class PaymentmethodRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/users/me/paymentmethod", path_parameters)
    ...
    @dataclass
    class PaymentmethodRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
