...
class WithInstallationItemRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/notifications/push/installations/{installationId}", path_parameters)
    ...
    def with_url(self,raw_url: str) -> WithInstallationItemRequestBuilder:
        """
        ...
        return WithInstallationItemRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class WithInstallationItemRequestBuilderDeleteRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
