...
class NotificationsItemRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[NotificationResponse]:
        ...
        return await self.request_adapter.send_async(request_info, NotificationResponse, error_mapping)
    ...
    def with_url(self,raw_url: str) -> NotificationsItemRequestBuilder:
        """
        ...
        return NotificationsItemRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class NotificationsItemRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
