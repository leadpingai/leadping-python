...
if TYPE_CHECKING:
    from ...models.paged_result_of_notification_table_row import PagedResultOfNotificationTableRow
    from ...models.problem_details import ProblemDetails
    from ...models.request_data_options import RequestDataOptions

class AnnouncementsRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/notifications/announcements", path_parameters)
    ...
    def with_url(self,raw_url: str) -> AnnouncementsRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: AnnouncementsRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return AnnouncementsRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class AnnouncementsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
