...
if TYPE_CHECKING:
    from ....models.paged_result_of_lead_table_row import PagedResultOfLeadTableRow
...
class MyRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/leads/all/my{?archiveFilter*,tagIds*,tagMatchAll*,untagged*}", path_parameters)
    ...
    async def post(self,body: RequestDataOptions, request_configuration: Optional[RequestConfiguration[MyRequestBuilderPostQueryParameters]] = None) -> Optional[PagedResultOfLeadTableRow]:
        ...
        return await self.request_adapter.send_async(request_info, PagedResultOfLeadTableRow, error_mapping)
    ...
    class MyRequestBuilderPostQueryParameters():
        ...
        def get_query_parameter(self,original_name: str) -> str:
            ...
            if original_name == "archive_filter":
                return "archiveFilter"
            if original_name == "tag_ids":
                return "tagIds"
            if original_name == "tag_match_all":
                return "tagMatchAll"
            if original_name == "untagged":
                return "untagged"
