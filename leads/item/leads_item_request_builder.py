...
if TYPE_CHECKING:
    ...
    from .workflow_status.workflow_status_request_builder import WorkflowStatusRequestBuilder

class LeadsItemRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/leads/{id}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[LeadResponse]:
        """
    ...
    def with_url(self,raw_url: str) -> LeadsItemRequestBuilder:
        """
        ...
        return LeadsItemRequestBuilder(self.request_adapter, raw_url)
    ...
    @property
    def workflow_status(self) -> WorkflowStatusRequestBuilder:
        """
        The workflowStatus property
        """
        from .workflow_status.workflow_status_request_builder import WorkflowStatusRequestBuilder

        return WorkflowStatusRequestBuilder(self.request_adapter, self.path_parameters)
    
    @dataclass
    class LeadsItemRequestBuilderDeleteRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
    ...
    @dataclass
    class LeadsItemRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
    ...
    @dataclass
    class LeadsItemRequestBuilderPutRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
