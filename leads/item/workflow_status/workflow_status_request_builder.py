...
if TYPE_CHECKING:
    from ....models.automation_workflow_status_response import AutomationWorkflowStatusResponse
...
class WorkflowStatusRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[AutomationWorkflowStatusResponse]:
        ...
        return await self.request_adapter.send_async(request_info, AutomationWorkflowStatusResponse, error_mapping)
    ...
    def with_url(self,raw_url: str) -> WorkflowStatusRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: WorkflowStatusRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return WorkflowStatusRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class WorkflowStatusRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
