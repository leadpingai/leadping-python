...
class ItemRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/leads/{%2Did}", path_parameters)
    ...
    @property
    def status_history(self) -> StatusHistoryRequestBuilder:
        """
        The statusHistory property
        """
        from .status_history.status_history_request_builder import StatusHistoryRequestBuilder

        return StatusHistoryRequestBuilder(self.request_adapter, self.path_parameters)
