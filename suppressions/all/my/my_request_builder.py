...
if TYPE_CHECKING:
    from ....models.paged_result_of_suppression_entry_response import PagedResultOfSuppressionEntryResponse
...
class MyRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/suppressions/all/my", path_parameters)
    ...
    async def post(self,body: RequestDataOptions, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[PagedResultOfSuppressionEntryResponse]:
        ...
        return await self.request_adapter.send_async(request_info, PagedResultOfSuppressionEntryResponse, error_mapping)
