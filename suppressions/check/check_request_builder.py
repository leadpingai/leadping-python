...
if TYPE_CHECKING:
    ...
    from ...models.suppression_check_result import SuppressionCheckResult
...
class CheckRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/suppressions/check", path_parameters)
    ...
    async def post(self,body: SuppressionEntryRequest, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[SuppressionCheckResult]:
        ...
        return await self.request_adapter.send_async(request_info, SuppressionCheckResult, error_mapping)
