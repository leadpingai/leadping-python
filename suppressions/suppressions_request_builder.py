...
class SuppressionsRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: SuppressionEntryRequest, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[SuppressionEntryResponse]:
        ...
        return await self.request_adapter.send_async(request_info, SuppressionEntryResponse, error_mapping)
    ...
    def with_url(self,raw_url: str) -> SuppressionsRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: SuppressionsRequestBuilder
        """
        if raw_url is None:
    ...
    @dataclass
    class SuppressionsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
