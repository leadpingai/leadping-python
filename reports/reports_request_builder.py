...
if TYPE_CHECKING:
    from .exports.exports_request_builder import ExportsRequestBuilder
...
class ReportsRequestBuilder(BaseRequestBuilder):
    ...
    @property
    def exports(self) -> ExportsRequestBuilder:
        """
        The exports property
        """
        from .exports.exports_request_builder import ExportsRequestBuilder

        return ExportsRequestBuilder(self.request_adapter, self.path_parameters)
