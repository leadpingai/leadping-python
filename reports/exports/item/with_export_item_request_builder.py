...
class WithExportItemRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/reports/exports/{exportId}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[UserDataExportResponse]:
        """
        ...
        Returns: Optional[UserDataExportResponse]
        """
    ...
    def with_url(self,raw_url: str) -> WithExportItemRequestBuilder:
        """
        ...
        return WithExportItemRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class WithExportItemRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
