...
class TokenRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /organizations/invitations/token
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/organizations/invitations/token", path_parameters)
    
    def by_token(self,token: str) -> WithTokenItemRequestBuilder:
        """
        Gets an item from the leadping.organizations.invitations.token.item collection
