...
if TYPE_CHECKING:
    from ...models.phone_number_search_request import PhoneNumberSearchRequest
...
class SearchRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/phone-numbers/search", path_parameters)
    ...
    async def post(self,body: PhoneNumberSearchRequest, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[PhoneNumberSearchResponse]:
        ...
        return await self.request_adapter.send_async(request_info, PhoneNumberSearchResponse, error_mapping)
