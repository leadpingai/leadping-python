...
if TYPE_CHECKING:
    from ....models.paged_result_of_phone_number_table_row import PagedResultOfPhoneNumberTableRow
...
class OrganizationRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/phone-numbers/all/organization", path_parameters)
    ...
    async def post(self,body: RequestDataOptions, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[PagedResultOfPhoneNumberTableRow]:
        ...
        return await self.request_adapter.send_async(request_info, PagedResultOfPhoneNumberTableRow, error_mapping)
    ...
    def with_url(self,raw_url: str) -> OrganizationRequestBuilder:
        """
    ...
    @dataclass
    class OrganizationRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
