...
if TYPE_CHECKING:
    from ...models.phone_number_availability_request import PhoneNumberAvailabilityRequest
    from ...models.phone_number_availability_response import PhoneNumberAvailabilityResponse
    from ...models.problem_details import ProblemDetails

class IsAvailableForPurchaseRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/phone-numbers/is-available-for-purchase", path_parameters)
    ...
    async def post(self,body: PhoneNumberAvailabilityRequest, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[PhoneNumberAvailabilityResponse]:
        ...
        return await self.request_adapter.send_async(request_info, PhoneNumberAvailabilityResponse, error_mapping)
    ...
    def with_url(self,raw_url: str) -> IsAvailableForPurchaseRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: IsAvailableForPurchaseRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return IsAvailableForPurchaseRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class IsAvailableForPurchaseRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
