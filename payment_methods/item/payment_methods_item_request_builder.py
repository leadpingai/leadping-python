...
class PaymentMethodsItemRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/payment-methods/{id}", path_parameters)
    ...
    def to_delete_request_information(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        ...
        request_info.headers.try_add("Accept", "application/json, application/problem+json")
        return request_info
    ...
    def with_url(self,raw_url: str) -> PaymentMethodsItemRequestBuilder:
        """
    ...
    @dataclass
    class PaymentMethodsItemRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
