...
if TYPE_CHECKING:
    from ....models.paged_result_of_lead_status_change_response import PagedResultOfLeadStatusChangeResponse
...
class MyRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/lead-status-changes/all/my", path_parameters)
    ...
    async def post(self,body: RequestDataOptions, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[PagedResultOfLeadStatusChangeResponse]:
        ...
        return await self.request_adapter.send_async(request_info, PagedResultOfLeadStatusChangeResponse, error_mapping)
