...
class MyRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/usage/summary/my{?periodEnd*,periodStart*}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[MyRequestBuilderGetQueryParameters]] = None) -> Optional[UsageSummaryResponse]:
        """
        ...
        Returns: Optional[UsageSummaryResponse]
        """
    ...
    class MyRequestBuilderGetQueryParameters():
        ...
        def get_query_parameter(self,original_name: str) -> str:
            ...
            if original_name == "period_end":
                return "periodEnd"
            if original_name == "period_start":
                return "periodStart"
