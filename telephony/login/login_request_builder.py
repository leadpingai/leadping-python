...
if TYPE_CHECKING:
    ...
    from ...models.telephony_login_request import TelephonyLoginRequest
    from ...models.telephony_login_response import TelephonyLoginResponse
...
class LoginRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/telephony/login", path_parameters)
    ...
    async def post(self,body: TelephonyLoginRequest, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[TelephonyLoginResponse]:
        ...
        return await self.request_adapter.send_async(request_info, TelephonyLoginResponse, error_mapping)
