...
if TYPE_CHECKING:
    from ...models.initiate_call_request import InitiateCallRequest
    from ...models.phone_call_response import PhoneCallResponse
    from ...models.problem_details import ProblemDetails

class InitiateRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /phone-call/initiate
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        """
        Instantiates a new InitiateRequestBuilder and sets the default values.
        param path_parameters: The raw url or the url-template parameters for the request.
        param request_adapter: The request adapter to use to execute the requests.
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/phone-call/initiate", path_parameters)
    ...
    def with_url(self,raw_url: str) -> InitiateRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: InitiateRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return InitiateRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class InitiateRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
