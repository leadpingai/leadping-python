...
if TYPE_CHECKING:
    from ....models.paged_result_of_automation_table_row import PagedResultOfAutomationTableRow
...
class MyRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/automations/all/my", path_parameters)
    
    async def post(self,body: RequestDataOptions, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[PagedResultOfAutomationTableRow]:
        """
        ...
        Returns: Optional[PagedResultOfAutomationTableRow]
        """
        if body is None:
        ...
        return await self.request_adapter.send_async(request_info, PagedResultOfAutomationTableRow, error_mapping)
