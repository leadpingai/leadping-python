...
if TYPE_CHECKING:
    from ....models.automation_console_response import AutomationConsoleResponse
...
class RunsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/automations/{id}/runs", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[AutomationConsoleResponse]:
        ...
        return await self.request_adapter.send_async(request_info, AutomationConsoleResponse, error_mapping)
    ...
    @dataclass
    class RunsRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
